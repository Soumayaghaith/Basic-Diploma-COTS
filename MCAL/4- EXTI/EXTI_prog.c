...
#elif INT0_SENSE_CONTROL == EXTI_ON_CHANGE
...
#elif INT1_SENSE_CONTROL == EXTI_ON_CHANGE
...
{
	uint8 Local_8ErrorState =OK;
	switch(Copy_IntCh)
	{
	case INT0 : SET_BIT(GICR,GICR_INT0); break;
	case INT1 : SET_BIT(GICR,GICR_INT1); break;
	case INT2 : SET_BIT(GICR,GICR_INT2); break;
	default : Local_8ErrorState =NOK; break;
	}

	return Local_8ErrorState;
...
uint8 EXTI_SetCallBack(IntChannel_t Copy_IntCh, void (Copy_pvCallBackFunc)(void))
{
	uint8 Local_ErrorState =OK;
	if(Copy_pvCallBackFunc != NULL)
	{
		if( (Copy_IntCh>2) || (Copy_IntCh<0) )
		{
